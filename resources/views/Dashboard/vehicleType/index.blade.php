            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a href="{{route('vehicleType.create')}}" class="btn btn-primary" role="button"
                       aria-pressed="true">إضافة نوع مركبة جديدة</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($vehicle->vehicleImage)
                                            <img src="{{URL::asset('uploadAttachment/'.$vehicle->vehicleImage)}}" data-src="{{URL::asset('uploadAttachment/'.$vehicle->vehicleImage)}}"
